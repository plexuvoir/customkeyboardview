...
import com.example.customtextinputeditext.KeyboardStuff.Keyboard
import com.example.customtextinputeditext.KeyboardStuff.KeyboardView
...
public class MainActivity : AppCompatActivity() {
    ...
    private fun configureCustomEditText() {
        ...
        amountEditText.setTextChangeEvent(amountEditText,"PHP",
            setUpKeyboard = {
                //Create the keyboard
                val keyboard = Keyboard(this,R.xml.amount_keyboard_layout)
...
//                    override fun onText(text: CharSequence) {}
            ...
            showCustomKeyboard = {
                keyboard_view.visibility = View.VISIBLE
