package com.example.customtextinputeditext.KeyboardStuff;
/*
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private int getKeyIndices(int x, int y, int[] allKeys) {
        final List<Keyboard.Key> keys = mKeyboard.getKeys();
    ...
    private void detectAndSendKey(int x, int y, long eventTime) {
        ...
        if (index != NOT_A_KEY) {
            vibrate();
            final Keyboard.Key key = mKeyboard.getKeys().get(index);
            if (key.text != null) {
    ...
    private boolean openPopupIfRequired(MotionEvent me) {
        ...
        Keyboard.Key popupKey = mKeyboard.getKeys().get(mCurrentKey);
    ...
    private boolean repeatKey() {
        Keyboard.Key key = mKeyboard.getKeys().get(mRepeatKeyIndex);
    ...
    private void checkMultiTap(long eventTime, int keyIndex) {
        ...
        Keyboard.Key key = mKeyboard.getKeys().get(keyIndex);
